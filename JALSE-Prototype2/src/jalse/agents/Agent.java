 ...
 * {@Attribute} as well as {@link AttributeListener} for trigger
 * code upon add, removal or change of those attributes. Agents can be wrapped
 * to a specific agent type as long as the inheriting interface follows what is
